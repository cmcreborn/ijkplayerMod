...
//    [[UIApplication sharedApplication] setStatusBarOrientation:UIInterfaceOrientationLandscapeLeft animated:NO];
    ...
    // FOR AIO5 PLAYER SETTING
    [options setPlayerOptionIntValue:1 forKey:@"soundtouch"];
    [options setCodecOptionIntValue:0 forKey:@"start-on-prepared"];
    [options setOptionIntValue:1 forKey:@"enable-accurate-seek" ofCategory:kIJKFFOptionCategoryPlayer];
    [options setFormatOptionValue:@"nobuffer" forKey:@"fflags"];
//    [options setPlayerOptionIntValue:300 forKey:@"max_cached_duration"];
    [options setFormatOptionIntValue:1 forKey:@"analyzeduration"];
     [options setFormatOptionIntValue:1 forKey:@"flush_packets"];
    [options setPlayerOptionIntValue:1 forKey:@"infbuf"];
//    [options setPlayerOptionIntValue:814572 forKey:@"max-buffer-size"];
    [options setPlayerOptionIntValue:4 forKey:@"packet-buffering"];
    
    [options setPlayerOptionIntValue:4 forKey:@"framedrop"];
    [options setFormatOptionIntValue:128 * 4 forKey:@"probesize"];
    [options setPlayerOptionIntValue:1 forKey:@"videotoolbox"];
    [options setCodecOptionIntValue:IJK_AVDISCARD_BIDIR forKey:@"skip_loop_filter"];
    [options setCodecOptionIntValue:IJK_AVDISCARD_BIDIR forKey:@"skip_frame"];
